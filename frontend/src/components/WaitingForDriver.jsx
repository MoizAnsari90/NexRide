...
const WaitingForDriver = ({ vehicle }) => {
  return (
    <div>
      {/* ETA Badge */}
      <div className='flex items-center justify-between mb-5'>
        <div>
          <h3 className='text-lg font-bold text-gray-800'>Meet at the pickup point</h3>
          <p className='text-sm text-gray-400'>Your driver is on the way</p>
        </div>
        <div className='bg-emerald-500 text-white px-4 py-2 rounded-xl text-center'>
          <p className='text-lg font-bold leading-tight'>2</p>
