...
const Riding = ({ pickup, destination, vehicle, onRideEnd }) => {
  return (
    <div>
      {/* Ride Status Header */}
      ...
      <button
        onClick={onRideEnd}
        className='w-full bg-red-500 text-white py-3.5 rounded-xl text-sm font-bold tracking-wide hover:bg-red-600 active:scale-[0.98] transition-all'
      >
        End Ride
      </button>
    </div>
