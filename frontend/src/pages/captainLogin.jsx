    ...
    <div className='min-h-screen w-screen bg-gradient-to-br from-gray-50 to-gray-100 flex flex-col'>
      ...
      <div className='flex-1 flex flex-col items-center justify-center px-6'>
        ...
        <div className='w-full max-w-sm bg-white rounded-2xl shadow-lg p-7'>
          <h2 className='text-xl font-bold text-gray-800 mb-1'>Captain Login</h2>
          <p className='text-sm text-gray-400 mb-6'>Sign in to start driving</p>
          ...
          <p className='text-center mt-5 text-sm text-gray-400'>
            ...
            <Link to='/captain-signup' className='text-emerald-600 font-semibold hover:underline'>Register</Link>
          </p>
        </div>
      </div>
